...
import com.ahnz.headmaster.utils.pic_mapping.VersionedGestureDetector;
...
public class PicsGestureLayout extends FrameLayout implements
    ...
    private Activity newSheJi;

    public PicsGestureLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        newSheJi = (HeaderDetailsActivity) getContext();
        init();
    }
